 ...
 */
public class ThreeCallsFragment extends Fragment implements View.OnClickListener {

    public static final String TAG = ThreeCallsFragment.class.getSimpleName();
    ...
    private OnSwipeToRefreshListenerThree mListener;
    private TextView txtAddressFull;

    public ThreeCallsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_three_calls, container, false);
        mSwipeRefreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.swipeToRefresh);
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                mListener.refreshThreeFragment();
                mSwipeRefreshLayout.setRefreshing(false);
            }
        });
        CardView policeCard = (CardView) v.findViewById(R.id.policeCard);
        CardView ambulanceCard = (CardView) v.findViewById(R.id.ambulanceCard);
        CardView fireCard = (CardView) v.findViewById(R.id.fireCard);
        TextView txtAddress = (TextView) v.findViewById(R.id.txtAddressCord);
        txtAddressFull = (TextView) v.findViewById(R.id.txtAddressFull);
    ...
    public void onAttach(Context context) {
        ...
        mListener = (OnSwipeToRefreshListenerThree) context;
    }
    ...
    Animator.AnimatorListener revealAnimationListener = new Animator.AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            Intent i = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + numCall));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.policeCard:
                numCall = mCountryClass.getPoliceNum();
                break;

            case R.id.ambulanceCard:
                numCall = mCountryClass.getAmbulanceNum();
                break;

            case R.id.fireCard:
                numCall = mCountryClass.getFireNum();
                break;
        }
    ...
    public interface OnSwipeToRefreshListenerThree {
        void refreshThreeFragment();
    }
}
